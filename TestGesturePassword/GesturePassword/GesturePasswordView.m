...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        goBackButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2-60, frame.size.height/2+220, 120, 30)];
        [goBackButton.titleLabel setFont:[UIFont systemFontOfSize:14]];
        [goBackButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [goBackButton setTitle:@"GO" forState:UIControlStateNormal];
        [goBackButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchDown];
